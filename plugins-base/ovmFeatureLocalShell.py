...
class ovmFeatureLocalShell:
    @classmethod
    def StatusUpdateHandler(cls, inPane):
        inPane.AddTitleField(Lang("Local Command Shell"))
    
        inPane.AddWrappedTextField(Lang(
            "Press <Enter> to start the CLI on this server.  "
    ...
    def StartLocalShell(self):
        ...
        Layout.Inst().SubshellCommandSet("( export HOME=/root; export TMOUT=0 && cat /etc/motd && /bin/bash --login && python /usr/libexec/ovm-admin/ovmUI.py)")
        ovmLog('Local shell')
    ...
    def Register(self):
        Importer.RegisterNamedPlugIn(
            ...
            'LOCAL_SHELL', # Key of this plugin for replacement, etc.
            {
                ...
                'statusupdatehandler' : ovmFeatureLocalShell.StatusUpdateHandler,
                'activatehandler' : ovmFeatureLocalShell.ActivateHandler
            }
        )

# Register this plugin when module is imported
#ovmFeatureLocalShell().Register()
