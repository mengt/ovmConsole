...
class LangFriendlyNames:
  ...
  friendlyNamesMap = {
    ...
    'Description-VDI.ovmstore_data' : 'data to be inserted into the ovmstore tree (/local/domain/0/backend/vbd/<domid>/<device-id>/sm-data) after the VDI is attached. This is generally set by the SM backends on vdi_attach.',
    ...
    'Description-VM.ovmstore_data' : 'data to be inserted into the ovmstore tree (/local/domain/<domid>/vm-data) after the VM is created.',
    ...
    'Description-host.capabilities' : 'ovm capabilities',
    ...
    'Description-host.edition' : 'UniServer edition',
    ...
    'Description-host.system_status-xapi-debug' : 'UniServer daemon crash dumps',
    'Description-host.system_status-xapi-subprocess' : 'UniServer daemon process details',
    'Description-host.system_status-ovm-info' : 'Details of the hypervisor version and its current state',
    'Description-host.system_status-UniServer-config' : 'Details of the UniServer such as version and build information, primary hard disk location and pool configuration',
    'Description-host.system_status-UniServer-databases' : 'The database which stores the state of the UniServer',
    'Description-host.system_status-UniServer-domains' : 'List of the guest VMs installed onto the server and their current states',
    'Description-host.system_status-UniServer-install' : 'Log files generated during the installation of the UniServer',
    'Description-host.system_status-UniServer-logs' : 'Log files concerning the UniServer\'s activity',
    ...
    'Exception-PowerShellExecutionPolicyRestricted' : 'Cannot load the UniServerPSSnapIn if the PowerShell \'ExecutionPolicy\' is equal to \'Restricted\'.',
    ...
    'Exception-PowerShellSnapInNotPresent' : 'You must have the UniServerPSSnapIn installed to use UniServer PowerShell Commands. This can be found in the SDK.',
    'Exception-SearchParseFailed' : 'Could not parse search \'{0}\' for plugin \'{1}\'.',
    'Exception-ovmSearchFileInvalid' : 'The file \'{0}\' is not a valid saved search.',
    ...
    'Label-SR.SRTypes-cslg' : 'Esage StorageLink Gateway',
    ...
    'Label-VDI.ovmstore_data' : 'VDI.ovmstore_data',
    ...
    'Label-VM.ovmstore_data' : 'VM.ovmstore_data',
    ...
    'Label-host.edition-enterprise' : 'Esage Essentials for UniServer, Enterprise Edition',
    'Label-host.edition-free' : 'Esage UniServer',
    'Label-host.edition-platinum' : 'Esage Essentials for UniServer, Platinum Edition',
    ...
    'Label-host.sku_type-FG-dell_xe_enterprise' : 'Esage Essentials for UniServer, Dell Enterprise Edition',
    'Label-host.sku_type-FG-dell_xe_express' : 'Esage UniServer Dell Edition',
    'Label-host.sku_type-FG-dell_xe_server' : 'Esage Essentials for UniServer, Dell Enterprise Edition',
    'Label-host.sku_type-FG-hp_xe_enterprise' : 'Esage Essentials for UniServer, HP Enterprise Edition',
    'Label-host.sku_type-FG-hp_xe_express' : 'Esage UniServer HP Edition',
    'Label-host.sku_type-FG-hp_xe_server' : 'Esage Essentials for UniServer, HP Enterprise Edition',
    'Label-host.sku_type-FG-xe_enterprise' : 'Esage Essentials for UniServer',
    'Label-host.sku_type-FG-xe_express' : 'Esage UniServer',
    'Label-host.sku_type-FG-xe_server' : 'Esage Essentials for UniServer',
    'Label-host.sku_type-dell_xe_enterprise' : 'Esage UniServer Dell Enterprise Edition',
    'Label-host.sku_type-dell_xe_express' : 'Esage UniServer Dell Express Edition',
    'Label-host.sku_type-dell_xe_server' : 'Esage UniServer Dell Server Edition',
    'Label-host.sku_type-hp_xe_enterprise' : 'Esage UniServer HP Enterprise Edition',
    'Label-host.sku_type-hp_xe_express' : 'Esage UniServer HP Select Edition',
    'Label-host.sku_type-hp_xe_server' : 'Esage UniServer HP Server Edition',
    'Label-host.sku_type-xe_enterprise' : 'Esage UniServer Enterprise Edition',
    'Label-host.sku_type-xe_express' : 'Esage UniServer Express Edition',
    'Label-host.sku_type-xe_server' : 'Esage UniServer Server Edition',
    'Label-host.software_version' : 'Version details',
    'Label-host.software_version-build_number' : 'UniServer build number',
    'Label-host.software_version-date' : 'UniServer build date',
    ...
    'Label-host.software_version-product_version' : 'UniServer version',
    'Label-host.supported_bootloaders' : 'host.supported_bootloaders',
    'Label-host.suspend_image_sr' : 'host.suspend_image_sr',
    'Label-host.system_status-CVSM' : 'Esage StorageLink configuration',
    ...
    'Label-host.system_status-client-logs' : 'UniCenter logs',
    ...
    'Label-host.system_status-xapi-debug' : 'UniServer daemon crash dumps',
    'Label-host.system_status-xapi-subprocess' : 'UniServer daemon subprocesses',
    'Label-host.system_status-ovm-info' : 'Hypervisor configuration',
    'Label-host.system_status-UniServer-config' : 'UniServer configuration',
    'Label-host.system_status-UniServer-databases' : 'UniServer database',
    'Label-host.system_status-UniServer-domains' : 'UniServer domains list',
    'Label-host.system_status-UniServer-install' : 'UniServer installation log files',
    'Label-host.system_status-UniServer-logs' : 'UniServer logs',
    ...
    'Label-performance.xapi_latency' : 'UniServer Healthcheck Latency',
    'Label-performance.xapi_live_memory_kib' : 'Agent Memory Live',
    'Label-performance.xapi_memory_usage_kib' : 'Agent Memory Usage',
    'Label-performance.ovmbr_rx' : '{0} Receive',
    'Label-performance.ovmbr_rx_errors' : '{0} Receive Errors',
    'Label-performance.ovmbr_tx' : '{0} Send',
    'Label-performance.ovmbr_tx_errors' : '{0} Send Errors',
    ...
    'Message.action-license_does_not_support_pooling' : 'Buy UniServer Online',
    'Message.action-license_expires_soon' : 'Buy UniServer Online',
    ...
    'Message.body-ha_xapi_healthcheck_approaching_timeout' : 'UniServer on server \'{0}\' is taking too long to respond and may fence.',
    ...
    'Message.body-license_does_not_support_pooling' : 'The license on server \'{0}\' has expired or been changed, and no longer supports UniServer Enterprise features.',
    ...
    'Message.body-multipath_periodic_alert' : 'Server \'{0}\' has experienced a change in multipath status. Currently {1} out of {2} paths are active. See the UniCenter logs for the full details.',
    'Message.body-multipath_periodic_alert_healthy' : 'Servers in pool \'{0}\' have experienced a change in multipath status. Currently all paths are active. See the UniCenter logs for the full details.',
    'Message.body-multipath_periodic_alert_healthy_standalone' : 'Server \'{0}\' has experienced a change in multipath status. Currently all paths are active. See the UniCenter logs for the full details.',
    'Message.body-multipath_periodic_alert_summary' : 'Servers in pool \'{0}\' have experienced a change in multipath status. Currently the following servers have inactive paths: {1}. See the ovmCenter logs for the full details.',
    ...
    'Message.name-ha_xapi_healthcheck_approaching_timeout' : 'UniServer healthcheck approaching timeout',
    'Message.name-host_clock_skew_detected' : 'Server clock not synchronized',
    'Message.name-host_sync_data_failed' : 'UniServer statistics synchronization failed',
    ...
    'Role.pool-admin.Description' : 'Pool Admins have full access to all UniServer features and settings. They can access the UniServer console and manage the roles of other users.\
 \
- No restrictions\
- Role and user management\
- Access to UniServer console',
...
- Read access only',
    ...
    'Role.vm-admin.Description' : 'VM Admins can manage VMs and Templates and can access the storage necessary to complete these tasks. This role relies on UniServer to choose where to run each VM, and on templates to provide values for dynamic memory control (DMC) and Home Server settings.\
 \
...
- Can set Home Server and choose where to run workloads',
    ...
    'SR.name_description-UniServer-tools' : 'UniServer Tools ISOs',
    ...
    'SR.name_label-UniServer-tools' : 'UniServer Tools',
    ...
    'VM.TemplateDescription-Esage ovmApp' : 'Installs Windows Server® 2003 32-bit, optimized for installation of Esage ovmApp.',
    'VM.TemplateDescription-Esage ovmApp x64' : 'Installs Windows Server® 2003 64-bit, optimized for installation of Esage ovmApp.',
